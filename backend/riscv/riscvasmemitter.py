...
class RiscvAsmEmitter(AsmEmitter):
    ...
    class RiscvInstrSelector(TACVisitor):
        ...
        def visitBinary(self, instr: Binary) -> None:
            instr_op=instr.op.__str__()[9:].lower()
            if instr_op=="equ":
                ...
                self.seq.append(Riscv.LoadImm(instr.lhs,1))
                self.seq.append(Riscv.Binary(BinaryOp.XOR,instr.dst,instr.dst,instr.lhs))
            elif instr_op=="leq":
                self.seq.append(Riscv.Binary(BinaryOp.SLT,instr.dst,instr.rhs,instr.lhs))
                self.seq.append(Riscv.LoadImm(instr.lhs,1))
                self.seq.append(Riscv.Binary(BinaryOp.XOR,instr.dst,instr.dst,instr.lhs))
            elif instr_op=="neq":
                self.seq.append(Riscv.Binary(BinaryOp.SUB,instr.dst,instr.lhs,instr.rhs))
        ...
        def visitAssign(self,instr: Assign) -> None:
            self.seq.append(Riscv.Unary(UnaryOp.MV,instr.dst,instr.src))
